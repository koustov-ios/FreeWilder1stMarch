...
@interface notificationsettingsViewController ()<UIGestureRecognizerDelegate,Slide_menu_delegate,footerdelegate,Serviceview_delegate,Profile_delegate,accountsubviewdelegate,accountsubviewdelegate,sideMenu,UITextFieldDelegate>
{
    NSString *firstdata,*secdata,*thirddata,*forthdata,*fifthdata,*sixthdata,*chk1,*chk2,*chk3,*chk4,*chk5,*chk6;
...
- (void)viewDidLoad {
    ...
    userid=[userdata valueForKey:@"UserId"];
...
-(void)urlfire
{
    ...
    NSString *urlstring=[NSString stringWithFormat:@"%@app_notification?userid=%@",App_Domain_Url,userid];
    
    [globalobj GlobalDict:urlstring Globalstr:@"array" Withblock:^(id result, NSError *error) {
        NSLog(@"resultdata %@",result);
        dic1=[result mutableCopy];
        dic2=[dic1 valueForKey:@"infoarray"];
        
        firstdata=[dic2 valueForKey:@"field_one"];
        secdata=[dic2 valueForKey:@"field_two"];
        thirddata=[dic2 valueForKey:@"field_three"];
        forthdata=[dic2 valueForKey:@"field_four"];
        fifthdata=[dic2 valueForKey:@"field_five"];
        sixthdata=[dic2 valueForKey:@"field_six"];
        
        
        chk1=[dic2 valueForKey:@"field_one"];
        chk2=[dic2 valueForKey:@"field_two"];
        chk3=[dic2 valueForKey:@"field_three"];
        chk4=[dic2 valueForKey:@"field_four"];
        chk5=[dic2 valueForKey:@"field_five"];
        chk6=[dic2 valueForKey:@"field_six"];
        
        
        
        if ([firstdata isEqualToString:@"Y"])
        {
            [_one setOn:YES animated:YES];
        }
        else
        {
            [_one setOn:NO animated:YES];
        }
        
        if ([secdata isEqualToString:@"Y"])
        {
            [_two setOn:YES animated:YES];
        }
        else
        {
            [_two setOn:NO animated:YES];
        }
        
        if ([thirddata isEqualToString:@"Y"])
        {
            [_three setOn:YES animated:YES];
        }
        else
        {
            [_three setOn:NO animated:YES];
        }
        
        
        if ([forthdata isEqualToString:@"Y"])
        {
            [_four setOn:YES animated:YES];
        }
        else
        {
            [_four setOn:NO animated:YES];
        }
        
        
        
        if ([fifthdata isEqualToString:@"Y"])
        {
            [_five setOn:YES animated:YES];
        }
        else
        {
            [_five setOn:NO animated:YES];
        }
        
        
        
        if ([sixthdata isEqualToString:@"Y"])
        {
            [_six setOn:YES animated:YES];
        }
        else
        {
            [_six setOn:NO animated:YES];
        }
...
- (IBAction)savebtn:(id)sender
{
    ...
    NSLog(@"%@,%@,%@,%@,%@,%@",firstdata,secdata,thirddata,forthdata,fifthdata,sixthdata);
    
    
    
    if ([firstdata isEqualToString:chk1] && [secdata isEqualToString:chk2] && [thirddata isEqualToString:chk3] && [forthdata isEqualToString:chk4] && [fifthdata isEqualToString:chk5] && [sixthdata isEqualToString:chk6])
    {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Nothing Changed"
                                                        message:@"old notification settings saved"
                                                       delegate:self
    ...
    else
    {
        ...
        NSString *urlstring=[NSString stringWithFormat:@"%@app_notification_update?userid=%@&field_one=%@&field_two=%@&field_three=%@&field_four=%@&field_five=%@&field_six=%@",App_Domain_Url,userid,fifthdata,secdata,thirddata,forthdata,fifthdata,sixthdata];
